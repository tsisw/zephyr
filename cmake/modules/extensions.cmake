...
function(zephyr_check_compiler_flag lang option check)
  ...
  if(EXISTS ${key_path})
    ...
    if(EXISTS $ENV{XTENSA_TOOLCHAIN_PATH})
      if("${CMAKE_REQUIRED_FLAGS}" STREQUAL "-nostartfiles -nostdlib -isystem \"${TOOLCHAIN_HOME}/llvm/lib/clang/10.0.1/include\" -isystem \"include-fixed\" -Wl,--unresolved-symbols=ignore-in-object-files" )
        set(key_value 1)
      endif()
    endif()
